        ...
        <div className={styles.CvContainer}>
          <div className={styles.leftside}>
            ...
            <div className={styles.interests}>
              ...
              <div className={styles.collectionInterest}>
                <div>
                  <div>
                    <img
                      src="https://webassets.mongodb.com/_com_assets/cms/JSON Document Copy 4@3x-aszlgv7njl.svg"
                      alt="html"
                    ></img>
                  </div>
                  <span>HTML</span>
                ...
                <div>
                  <div>
                    <img
                      src="https://webassets.mongodb.com/_com_assets/cms/Stitch triggers-ryg6nk6gv4.svg"
                      alt="css"
                    ></img>
                  </div>
                  <span>CSS</span>
              ...
              <div className={styles.collectionInterest}>
                ...
                <div>
                  <div>
                    <svg height="45" width="22" viewBox="0 0 13 26">
                      <path
            ...
            <div className={styles.contacts}>
              ...
              <div className={styles.list}>
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=miroz.devkota@gmail.com"
                  target="_blank"
                >
                  <div className={styles.icons}>
